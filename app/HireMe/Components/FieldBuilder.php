...
class FieldBuilder {
    ...
    public function buildTemplate($type)
    {
        ...
        {
            return 'fields/' . $type; //laravel concatenea al inicio el app y al final el blade.php
        }
    ...
    /**
     * funcion que php llama cuando hay un llamado a una funcion que no existe
     * @param $method
     * @param $params
     * @return function
     */
    ...
    {
        // adds the second arg to the first array argument
